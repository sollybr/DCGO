...
{
    public class LM_063 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                bool CanUseCondition(Hashtable hashtable)
                {
                    return !card.Owner.GetBattleAreaPermanents().Some(permanet =>
                        permanet.TopCard.EqualsCardName("Endurance Training"));
                }
            ...
            {
                ActivateClass activateClass = new ActivateClass();
                activateClass.SetUpICardEffect("1 of your Digimon may digivolve into a red/purple for 2 less", CanUseCondition, card);
                activateClass.SetUpActivateClass(null, ActivateCoroutine, -1, false, EffectDescription());
                cardEffects.Add(activateClass);

                string EffectDescription()
                {
                    return "[Main] <Delay> - 1 of your Digimon may digivolve into a Red or Purple Digimon card in the hand with the digivolution cost reduced by 2.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: "[Main] Reveal the top 2 cards of your deck. Add 1 Red or Purple card among them to the hand. Return the rest at the bottom of your deck. Then, place this card in the battle area.");
            }
            #endregion
